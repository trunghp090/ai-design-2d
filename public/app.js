...
const PNL_METRICS = [
  ...
  { k: "atc",      ic: "🛒", label: "Add to cart (FB)",  def: true },
  { k: "ic",       ic: "💳", label: "Checkout (FB)",     def: true },
  { k: "fb_purchase", ic: "✅", label: "Mua hàng (FB)",  def: true },
...
function pnlRenderCards(d) {
  ...
  const V = {
    ...
    atc:      [fmtNum(c.atc || 0), pnlDelta(c.atc || 0, p.atc || 0, true)],
